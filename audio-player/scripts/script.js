const playPause =
  document.getElementById("play-pause"); /*select play/pause button*/
const trackDuration =
  document.getElementById("track-duration"); /*select duration div */
const trackCT =
  document.getElementById(
    "track-current-time"
  ); /*select track's current time div */
const trackCover =
  document.getElementById("cover"); /*select div for track cover */
const trackAuthor =
  document.getElementById("track-author"); /*select div for track author */
const trackName =
  document.getElementById("track-name"); /*select div for track author */
const progBar =
  document.getElementById("progr"); /*select div for progressbar */
const progress =
  document.getElementById("duration-bar"); /*select div for progressbar outer */
const nextTrack =
  document.getElementById("track-next"); /*select div for next track button */
const prevTrack =
  document.getElementById("track-prev"); /*select div for prev track button */
